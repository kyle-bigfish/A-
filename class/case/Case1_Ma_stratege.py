...
# =====读入股票数据
stock_code = 'sz000002'
df = pd.read_csv('D:\\workspace\\homework\\basic-trading-data.20190625\\stock_data\\%s.csv' % stock_code,
...
# =====将数据存入hdf文件中
df.to_hdf('D:\python\pycharm\\untitled\homework\data\\signals.h5', key='df', mode='w')
